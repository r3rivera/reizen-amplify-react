      ...
      <div className="mx-auto max-w-7xl px-6 pt-20 pb-10 sm:pb-4 lg:flex lg:px-8 lg:py-43">
        <div className="mx-auto max-w-2xl lg:mx-0 lg:shrink-0 lg:pt-8">
            <span className="flex center">
              <ClickLogo altName="R2 Rivera" sourceUrl="/R2Logo.jpg" targetUrl="/control-panel" isClickable={true} className="h-26 pt-3"/>
              <div className="mt-5 text-5xl font-semibold tracking-tight text-pretty text-gray-900 sm:text-7xl h-26">
              |2 Rivera
              </div>
            </span>
